...
currently supported. PKCS#8 `PRIVATE KEY`, PKCS#1 `RSA PRIVATE KEY`, and SEC1
named-curve `EC PRIVATE KEY` encodings are accepted. The service rejects
missing, malformed, or mismatched material during startup and does not publish
a partial KeyStore.
