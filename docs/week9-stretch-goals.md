...
named-curve EC SEC1 private keys. It rejects an `ENCRYPTED PRIVATE KEY` block
with a specific unsupported-feature message. Kubernetes `kubernetes.io/tls`
Secrets do not define a standard field containing a private-key passphrase.
